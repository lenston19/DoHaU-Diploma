...
const read = async () => {
  ...
  rows.value = response.data.showCounterReference;
};
const deleteById = async (id: number) => {
  await graphqlRequest(`mutation deleteCounterReference{
      deleteCounterReference(id:${id})
    }`);
  await read();
};
...
const create = async (form: any) => {
  ...
  let q = `mutation
      createCounterReference($input: CounterReferenceDataInput!){
